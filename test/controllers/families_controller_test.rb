...
class FamiliesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create family" do
    assert_difference("Family.count") do
      post families_url, params: { family: { description: @family.description, discount: @family.discount, name: @family.name, profit: @family.profit } }
    end
  ...
  test "should update family" do
    patch family_url(@family), params: { family: { description: @family.description, discount: @family.discount, name: @family.name, profit: @family.profit } }
